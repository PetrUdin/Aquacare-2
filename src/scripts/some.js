...
document.addEventListener("DOMContentLoaded", () => {
  ...
  burger.addEventListener("click", () => {
    ...
    document.body.classList.toggle("jactive");
  });
  ...
  validateForms(
    ".form",
    { email: {required: true, email: true}, tel: { required: true }, checkbox: {required: true}},
    '.thanks-popup',
    "send goal"
  );
...
tab = document.querySelectorAll(".services__title");
content = document.querySelectorAll(".services__content");
...
buttons.forEach((item) => {
  item.addEventListener("click", () => {
    ...
    document.body.classList.add("jactive");
  });
});
popupClose.addEventListener("click", function () {
  popup.classList.remove("popup-active");
  document.body.classList.remove("jactive");
});
